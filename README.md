...
- **2025.09 – 2025.12 | AdaptVis_modified**  
  ...
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?logo=github&logoColor=white)](https://github.com/haewon22/AdaptVis_modified)

- **2025.03 – 2025.06 | DCLIP**  
  From-scratch reproduction of DCLIP, with additional work on UnmixRate metric and HNS loss.  
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?logo=github&logoColor=white)](https://github.com/haewon22/DCLIP)   
  👇👇👇For more details, see the project portfolio.    
  [![Portfolio PDF](https://img.shields.io/badge/PDF-AdaptVis%20%26%20DCLIP-EA4335?style=flat&logo=adobeacrobatreader&logoColor=white)](./Project.pdf)    

- **2025 | Uni-DTHON**  
  Silver Prize, DACON x Uni-DTHON  
  Query-based Vision-Language Model for Predicting Visual Element Positions in Documents  
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?logo=github&logoColor=white)](https://github.com/haewon22/Unid-DTHON-2025)

- **2024.06 | Image Segmentation Model Implementation and Lightweight Tuning**  
  Built a modified MiniNet-based segmentation model for constrained environments.  
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?logo=github&logoColor=white)](https://github.com/haewon22/CV_submission-ImageSegmentation)

- **2023.12 | Lightweight Recycling Classification Model for Real-Time Jetson Nano Inference**  
  Lightweight embedded AI project with pruning and knowledge distillation on Jetson Nano.  
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-181717?logo=github&logoColor=white)](https://github.com/haewon22/2024-EmbeddedAI-project-JetsonNano-Compression)
